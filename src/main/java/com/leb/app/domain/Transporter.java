...
public class Transporter implements Serializable {
    ...
    public Transporter routes(Set<Route> routes) {
        this.setRoutes(routes);
        return this;
    }

    public Transporter addRoutes(Route route) {
        this.routes.add(route);
        return this;
    }

    public Transporter removeRoutes(Route route) {
