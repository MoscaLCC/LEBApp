...
export class DimensionsComponent implements OnInit {
  ...
  trackId(index: number, item: IDimensions): number {
    return item.id!;
  }

  delete(dimensions: IDimensions): void {
    const modalRef = this.modalService.open(DimensionsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IDimensions[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
