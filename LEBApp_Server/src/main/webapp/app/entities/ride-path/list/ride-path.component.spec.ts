...
describe('Component Tests', () => {
  describe('RidePath Management Component', () => {
    let comp: RidePathComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RidePathComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ridePaths?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
