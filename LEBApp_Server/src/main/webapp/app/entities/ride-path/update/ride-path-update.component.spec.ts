...
describe('RidePath Management Update Component', () => {
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<RidePath>>();
      const ridePath = { id: 123 };
      jest.spyOn(ridePathService, 'update').mockReturnValue(saveSubject);
    ...
    it('Should call create service on save for new entity', () => {
      ...
      jest.spyOn(ridePathService, 'create').mockReturnValue(saveSubject);
      jest.spyOn(comp, 'previousState');
      activatedRoute.data = of({ ridePath });
      comp.ngOnInit();
