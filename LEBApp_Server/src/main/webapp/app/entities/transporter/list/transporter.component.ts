...
export class TransporterComponent implements OnInit {
  ...
  trackId(index: number, item: ITransporter): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITransporter[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
