...
import com.leb.app.service.ZoneQueryService;
...
/**
 * REST controller for managing {@link com.leb.app.domain.Zone}.
 */
@RestController
@RequestMapping("/api")
public class ZoneResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/zones/{id}", consumes = "application/merge-patch+json")
